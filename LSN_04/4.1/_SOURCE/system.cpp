...
// Write current configuration as a .xyz file in directory ../<phase>/CONFIG/
...
void System :: read_configuration(){
	ifstream cinf;
	cinf.open("../_INPUT/CONFIG/config.xyz");
	if(cinf.is_open()){
		string comment;
		string particle;
		double x, y, z;
	...
	if(_restart and _sim_type > 1){
		int spin;
		cinf.open("../_INPUT/CONFIG/config.spin");
		for(int i=0; i<_npart; i++){
			cinf >> spin;
...
void System :: averages(int blk){
	...
	// TOTAL ENERGY //////////////////////////////////////////////////////////////
	if (_measure_tenergy and !_equilibration){
	...
	// PRESSURE //////////////////////////////////////////////////////////////////
	if (_measure_pressure and !_equilibration){
	...
	// MAGNETIZATION /////////////////////////////////////////////////////////////
	if (_measure_magnet and !_equilibration){
	...
	// SPECIFIC HEAT /////////////////////////////////////////////////////////////
	if (_measure_cv and !_equilibration){
	...
	// SUSCEPTIBILITY ////////////////////////////////////////////////////////////
	if (_measure_chi and !_equilibration){
