...
void Random ::RandomImplementation(){
...
double Random :: Exponent(double lambda){
   // This function generates a random number from an exponential distribution with the given scale factor lambda
   double y = Rannyu();
   return - 1/lambda * log(1. - y);
}
  
double Random :: CauchyLorentz(double mean, double gamma){
   // This function generates a random number from a Cauchy-Lorentz distribution with the given mean and gamma 
   double y = Rannyu();
