...
private:
	...
	// Simulation usefuls
	bool _equilibration;
	string _phase;					 // Type of phase {Gas,Liquid,Solid}
	int _int_phase;
	int _input_count;
	string _input_dir;
	string _output_dir;
	...
	bool _index_penergy, _index_kenergy, _index_tenergy;			 // Indices for accessing energy-related properties in vec _measurement
...
public: // Function declarations
	...
	void initialize(string input_dir);					// Initialize system properties from input file
	void initialize_properties();// Initialize properties for measurement
	void initialize_spin();// Initialize spin for measurement
	void finalize();						// Finalize system and clean up
	void save_final_block(int blk);
